...
public class _Initializer {
    ...
    public static void Init(){
        ...
        try {
            ...
            statement_Trade= connection.prepareStatement("CREATE TABLE IF NOT EXISTS trades(id int PRIMARY KEY , appOwnID int , rsecOwnID int, submitDate  Date , acceptDate Date , status varchar(100), FOREIGN KEY (appOwnID) References  POSSESSION(IDPOSS))");
            statement_Trade.execute();



            statement_Friends = connection.prepareStatement("CREATE TABLE IF NOT EXISTS friends (id1 int PRIMARY KEY  AUTO_INCREMENT, id2 int PRIMARY KEY , FOREIGN KEY (id1) REFERENCES users(id), FOREIGN KEY (id2) REFERENCES  users(id)); ");
